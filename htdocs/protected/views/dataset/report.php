			...
			case 1:
				...
				<table class='reportTable'>
					...
					<tbody>		
						...
						<tr>
							<td>Female:</td>
							<td><?php echo $reportArray['female'].' ('.$reportArray['female_percent'].'%)'; ?></td>
						</tr>
						<tr>
							<td>Male:</td>
							<td><?php echo $reportArray['male'].' ('.$reportArray['male_percent'].'%)'; ?></td>
						</tr>
						<tr>
							<td>Average age:</td>
							<td><?php echo $reportArray['average_age'].' ('.$reportArray['min_age'].' to '.$reportArray['max_age'].')'; ?></td>
						</tr>
					</tbody>	
				</table>
